-- Tablas correspondientes al ejercicio con sus relaciones entre ellas
...
-- CONSULTAS CORRESPONDIENTES AL EJERCICIO
...
SELECT nombre, apellido1, apellido2, puesto FROM empleado WHERE puesto NOT LIKE 'representante';

--  Devuelve un listado con el nombre, apellidos y puesto de los clientes que son de España
...
SELECT e1.nombre, e1.apellido1, e1.apellido2, e2.nombre, e2.apellido1, e2.apellido2
FROM empleado e1
